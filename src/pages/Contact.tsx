                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      required
                      className="mt-2 border-2 border-black min-h-[150px]"
                    />
                  </div>
                  ...
                  <Button 
                    type="submit" 
                    disabled={submitting}
                    className="w-full bg-[#d60013] hover:bg-[#d60013]/90 text-white font-bold border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-none hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all"
                  >
