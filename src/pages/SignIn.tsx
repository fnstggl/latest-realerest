      ...
      <div className="w-full p-4 sm:p-6 md:p-8 flex flex-col">
        ...
        <div className="mx-auto w-full max-w-md bg-white/75 backdrop-blur-lg border border-white/30 p-4 sm:p-6 md:p-8 rounded-xl shadow-lg">
          <div className="mb-4 sm:mb-6 md:mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">Sign in to continue to Realer Estate. It's free.</p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-4 sm:space-y-6">
            <div>
              ...
              <Input type="email" id="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} required className="mt-1 sm:mt-2 bg-white border-gray-200 focus:border-gray-300 focus:ring-0 text-sm sm:text-base" />
            </div>
            <div>
              <Label htmlFor="password" className="font-bold text-black text-sm sm:text-base">Password</Label>
              <Input type="password" id="password" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} required className="mt-1 sm:mt-2 bg-white border-gray-200 focus:border-gray-300 focus:ring-0 text-sm sm:text-base" />
            </div>
            <div className="relative">
              <div className="gradient-border-container">
                <button type="submit" disabled={isLoading} className="gradient-border-button w-full font-futura font-bold">
