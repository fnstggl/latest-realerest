      ...
      <div className="w-full p-8 flex flex-col">
        ...
        <div className="mx-auto w-full max-w-md bg-white/75 backdrop-blur-lg border border-white/30 p-8 rounded-xl shadow-lg">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Join Realer Estate and start finding your dream home.</p>
          </div>
          ...
          {signupSuccess ? <div className="text-center p-6 bg-white/75 backdrop-blur-lg border border-green-300 rounded-md mb-6">
              ...
              <div>
                ...
                <Input type="text" id="name" placeholder="Enter your name" value={name} onChange={e => setName(e.target.value)} required className="mt-2 bg-white border-gray-200 focus:border-gray-300 focus:ring-0" />
              </div>
              <div>
                <Label htmlFor="email" className="font-bold text-black">Email</Label>
                <Input type="email" id="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} required className="mt-2 bg-white border-gray-200 focus:border-gray-300 focus:ring-0" />
              </div>
              <div>
                <Label htmlFor="password" className="font-bold text-black">Password</Label>
                <Input type="password" id="password" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} required className="mt-2 bg-white border-gray-200 focus:border-gray-300 focus:ring-0" />
                <p className="text-xs text-gray-500 mt-1">Password must be at least 6 characters long</p>
              </div>
              <div className="relative">
                <div className="gradient-border-container">
                  <button type="submit" className="gradient-border-button w-full font-futura font-bold" disabled={isLoading}>
