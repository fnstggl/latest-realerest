        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-16 md:space-y-24">
            ...
            >
              ...
              <div className="w-full md:w-1/2 relative">
                <div className="rounded-xl overflow-hidden shadow-lg">
                  <img src="/step1-image.jpg" alt="Find a property you love" className="w-full h-auto" />
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 relative">
                <div className="rounded-xl overflow-hidden shadow-lg">
                  <img src="/step3-image.jpg" alt="Send in an offer" className="w-full h-auto" />
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 relative">
                <div className="rounded-xl overflow-hidden shadow-lg">
                  <img src="/step4-image.jpg" alt="Get the keys" className="w-full h-auto" />
                </div>
              </div>
            </motion.div>
          </div>
