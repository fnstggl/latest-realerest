...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transform hover:translate-y-[-2px]",
  {
    variants: {
      variant: {
        ...
        navy: "bg-white/30 text-white backdrop-blur-md rounded-xl hover:bg-white/40 shadow-lg border border-white/30 search-glow layer-2",
        red: "bg-white/30 text-white backdrop-blur-md rounded-xl hover:bg-white/40 shadow-lg border border-white/30 search-glow layer-2",
      },
      size: {
