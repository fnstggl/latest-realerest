    ...
    <form onSubmit={handleSearch} className={`searchbar-isolated relative w-full max-w-3xl ${className} group`}>
      <div className="relative flex w-full">
        <input
          ...
          className="w-full px-4 sm:px-6 py-3 sm:py-4 text-[0.625rem] text-[#a8a8a8] placeholder-[#a8a8a8] bg-[#fafcfe] border-[3px] border-[#76818f] rounded-xl shadow-none font-bold font-inter relative z-10 focus:text-[#737a87] transition-all duration-300"
        />
        <GlowEffect
