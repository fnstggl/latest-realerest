        ...
        <div className="border-b border-gray-200 p-4">
          <div className="flex justify-between items-center">
            ...
            <Button 
              ...
              className="text-xs text-black hover:text-black font-medium relative border border-[#fd4801] opacity-0 hover:opacity-100 hover:bg-white rounded-lg px-3 py-1"
            >
              Mark all as read
            </Button>
          </div>
