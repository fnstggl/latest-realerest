...
const PropertiesTab: React.FC<PropertiesTabProps> = ({
  ...
  return <>
      {isLoading ? <div className="bg-white p-12 text-center rounded-xl border border-gray-200">
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-6 flex-1">
                  ...
                  <div className="flex gap-4 flex-wrap md:flex-nowrap">
                    <Button asChild className="bg-white text-black border border-gray-200 text-xs md:text-sm px-2 md:px-4">
          ...
          <Button asChild variant="glass" className="bg-white text-black border border-gray-200 text-xs md:text-sm px-2 md:px-4">
            <Link to="/sell/create">
