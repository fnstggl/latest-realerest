                    ...
                    <div className="flex gap-2">
                      {user.status === 'pending' && (
                        <>
                          ...
                          <Button 
                            size="sm" 
                            className="bg-white text-[#FF5C00] hover:text-white hover:bg-[#FD3DB5] border border-white/40 hover:border-[#FD3DB5] transition-colors shadow-sm hover:shadow-[0_0_10px_rgba(253,61,181,0.5)]"
                            onClick={() => handleUpdateWaitlistStatus(
                              user.id, 
                              'declined', 
                              user.propertyId, 
