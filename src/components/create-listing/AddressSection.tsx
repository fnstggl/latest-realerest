      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          field
                ...
                <FormControl>
                  <Input placeholder="e.g. Portland" className="h-12 rounded-xl border-black/10" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
          ...
          field
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent className="rounded-xl max-h-[280px] bg-white border border-black/10">
                    {usStates.map(state => <SelectItem key={state} value={state} className="relative hover:bg-transparent focus:bg-transparent active:bg-transparent group">
                        {state}
                        <span className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity" style={{
          ...
          field
                ...
                <FormControl>
                  <Input placeholder="e.g. 97204" className="h-12 rounded-xl border-black/10" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
        </div>
