...
const PropertyDetails: React.FC<PropertyDetailsProps> = ({ 
  ...
  return (
    <div className="glass-card property-card-glow h-full backdrop-blur-lg border border-white/20 shadow-lg p-4 sm:p-6 rounded-xl perspective-container layer-1">
      <h2 className="text-xl sm:text-2xl font-bold mb-4 text-black layer-1">The Numbers</h2>
      
      <div className="space-y-4 text-sm sm:text-base">
        <div className="flex justify-between glass-content p-2 rounded-lg backdrop-blur-sm border border-white/10 shadow-sm layer-2">
        ...
        {afterRepairValue !== undefined && (
          <div className="flex justify-between glass-content p-3 rounded-lg backdrop-blur-sm border border-white/10 shadow-sm layer-3">
