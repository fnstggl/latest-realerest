...
const PropertyDescription: React.FC<PropertyDescriptionProps> = ({
  ...
  const hasPropertyDetails = afterRepairValue !== undefined || 
  ...
  return (
    <div className="p-4 sm:p-6 rounded-xl bg-white my-0">
        ...
        <div className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-white rounded-lg">
            {afterRepairValue !== undefined && (
              <div className="flex justify-between p-3 border rounded-lg bg-white">
