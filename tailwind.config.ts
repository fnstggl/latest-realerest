	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-orange': 'linear-gradient(135deg, #fd4801 0%, #FDBA74 100%)',
				'gradient-pink': 'linear-gradient(135deg, #FF3CAC 0%, #F8A4D8 100%)',
				'gradient-peach': 'linear-gradient(135deg, #FDE1D3 0%, #FECACA 100%)',
				'gradient-orange-pink': 'linear-gradient(135deg, #fd4801 0%, #FF3CAC 100%)',
				...
				'rainbow-gradient': 'linear-gradient(124deg, #fd4801, #fd4801, #fd4801, #fd4801, #fd4801, #fd4801, #fd4801, #fd4801, #fd4801)',
